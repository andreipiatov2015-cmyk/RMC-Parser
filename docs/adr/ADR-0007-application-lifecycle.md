...
**Superseded** — `ApplicationLifecycle`/`LifecycleReport` и `DeveloperWindow` удалены из
проекта вместе с остальным кодом, завязанным на Selenium/Browser Engine. Документ сохранён
